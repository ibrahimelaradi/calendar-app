...
exports.FiltersSchema = typebox_1.Type.Object({
    ...
    inviteeId: typebox_1.Type.Optional(typebox_1.Type.String()),
    inviterId: typebox_1.Type.Optional(typebox_1.Type.String()),
    inviteStatus: typebox_1.Type.Optional(typebox_1.Type.String()),
